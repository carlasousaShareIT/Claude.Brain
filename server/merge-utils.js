...
export const mergeBrains = (a, b) => {
  const merged = { workingStyle: [], architecture: [], agentRules: [], decisions: [], log: [], archived: [...(a.archived || []), ...(b.archived || [])], webhooks: [...(a.webhooks || [])], projects: [...(a.projects || DEFAULT_PROJECTS)] };
