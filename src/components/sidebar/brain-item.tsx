...
import { cn, timeAgo, entryText, truncate } from '@/lib/utils'
...
export function BrainItem({ entry, section, isArchived = false }: BrainItemProps) {
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
          ...
          {annotations.length > 0 && (
            <span className="inline-flex items-center gap-0.5 text-[10px] text-[#62627a]">
